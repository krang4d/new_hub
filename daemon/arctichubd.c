...
const int					garctichubdPort=30333;

/* the path to our lock file */
const char *const			gLockFilePath = "/var/run/arctichubd.pid";
...
int main(int argc,char *argv[])
{
	...
	if((result=BecomeDaemonProcess(gLockFilePath,"arctichubd",
	...
	if((result=BindPassiveSocket(garctichubdPort,&gMasterSocket))<0)
		{
